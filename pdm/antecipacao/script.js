...
function pagarTaxa() {
    // Redirecionar para o link de pagamento na mesma guia
    window.location.href = 'https://pay.pagbrasilpagamento.com/checkout/258e702e-ca5c-477a-9934-20de8b2f2441';
}

// Função para pagamento da antecipação
function pagarAntecipacao() {
    // Redirecionar para o link de pagamento na mesma guia
    window.location.href = 'https://pay.transacaobrasil.com/checkout/ed50e23a-3720-486c-a07c-56a1011a2f0e';
}
...
function nextUpsell() {
    ...
    if (button) {
        ...
        setTimeout(() => {
            ...
            } else if (currentPage.includes('upsell2.html')) {
                window.location.href = 'upsell3.html';
            } else if (currentPage.includes('upsell3.html')) {
                window.location.href = 'upsell4.html';
            } else if (currentPage.includes('upsell4.html')) {
                window.location.href = 'upsell5.html';
            } else if (currentPage.includes('upsell5.html')) {
                complete();
            }
        }, 1500);
    }
...
function pagarAntecipacao() {
    // Redirecionar para o link de pagamento da antecipação
    window.location.href = 'https://pay.pagbrasilpagamento.com/checkout/258e702e-ca5c-477a-9934-20de8b2f2441';
}
